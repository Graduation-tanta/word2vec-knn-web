...
def generate_batch(batch_size, num_skips, skip_window):
    ...
    for i in range(batch_size // num_skips):
        ...
        buffer.append(data[data_index])
        data_index = (data_index + 1 + random.randint(0, 1000)) % len(data)
    return batch, labels
...
with open('wikipedia.pic', 'wb') as f:
    pickle.dump({'reverse_dictionary': reverse_dictionary, 'dictionary': dictionary, 'count': count, 'final_embeddings': final_embeddings}, f)
